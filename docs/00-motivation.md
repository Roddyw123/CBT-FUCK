# CBT-FUCK
CBT-FUCK is a hobbyist bidirectional C ↔ Brainfuck transpiler built with a focus on simplicity, correctness, and extensibility. It is a complete rewrite of CBT, another bidrectional C ↔ Brainfuck transpiler built solely on C.
